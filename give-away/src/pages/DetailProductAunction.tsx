      ...
      <div className="detaildisplay">
        <div className="detaildisplay-left">
          <div className="detaildisplay-img-list">
            ...
            />
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9ph72uwNLRO6XZ4QJ_060CrIn2_IXLmfRNg&s"
              alt="#"
            />
            <img
          ...
          <div className="detaildisplay-img">
            <Card>
              <img
                className="detaildisplay-main-img"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQo0eiEg1QmLNnNqEi90l5GwmHByWe7c1Vcng&s"
                alt=""
              />
            </Card>
          </div>
        ...
        <div className="detaildisplay-right">
          ...
          <div className="detaildisplay-right-price">
            <div className="detaildisplay-right-price-old">VND</div>
            <div className="detaildisplay-right-price-new">VND</div>
          </div>
