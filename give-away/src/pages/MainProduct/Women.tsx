...
const Women = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `http://giveawayproject.jettonetto.org:8080/api/fashionitems?PageSize=12&Status=Available&Type=ItemBase&Type=ConsignedForSale&GenderType=Female`
      )
      .then((response) => {
  ...
  const pageChange = (page: number, pageSize: number) => {
    ...
    axios
      .get(
        `http://giveawayproject.jettonetto.org:8080/api/fashionitems?Status=Available&Type=ItemBase&Type=ConsignedForSale&pageNumber&pageSize=12&GenderType=Female`
      )
      .then((response) => {
        const data = response.data;
