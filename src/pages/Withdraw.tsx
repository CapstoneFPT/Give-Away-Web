...
import {Button, Card, Col, Form, Input, message, Modal, Row, Space, Spin, Typography} from "antd";
import {BankOutlined, ExclamationCircleOutlined, SendOutlined} from "@ant-design/icons";
...
const Withdraw: React.FC = () => {
    ...
    const handleWithdraw = async (values: { amount: number }) => {
        ...
        try {
            ...
            message.error("Withdrawal request failed. Please check your information!");
            console.error("API error:", error);
            setWithdrawLoading(false);
        }
    };

    const handleBankAccountOperation = async (operation: 'add' | 'edit' | 'remove', values: UpdateBankAccountRequest & {
        ...
        try {
            switch (operation) {
                ...
                case 'remove':
                    ...
                    await accountApi.apiAccountsAccountIdBankaccountsBankAccountIdDelete(userId, values.bankAccountId);
            ...
            if (e instanceof AxiosError && e.response?.data.errorCode === ErrorCode.NoBankAccountLeft) {
        ...
        <Card style={{marginBottom: "16px", background: "#fff"}}>
            <Space align="center" style={{width: "100%"}}>
                ...
                <div>
                    ...
                    <Text>{selectedBank!.bankAccountNumber}</Text><br/>
                ...
                <Col span={19}>
                    <Spin spinning={isBankAccountsLoading}>
                        ...
                        <BankSelectionModal
                            ...
                            onEditBankAccount={(values) => handleBankAccountOperation('edit', values)}
                            onRemoveBankAccount={(bankAccountId) => handleBankAccountOperation('remove', {bankAccountId})}
