...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const { masterItemId, name, images, brand, gender, itemCode, stockCount,itemInStock } =
    product;
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "left", marginTop: 10 }}>
        ...
        <br />
        <ProductDetail label="Total" value={itemInStock?.toString()} />
      </div>
    </Card>
  );
};

const ProductDetail: React.FC<{ label: string; value?: string | number }> = ({
  label,
  value,
}) => (
  <Text>
